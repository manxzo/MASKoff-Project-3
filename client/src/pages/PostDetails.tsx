...
import { Post } from "@/config/ChatsConfig";
...
const PostDetails: React.FC = () => {
    ...
    if (loading) return <DefaultLayout><p>Loading post...</p></DefaultLayout>
    if (error) return <DefaultLayout><p>! {error}</p></DefaultLayout>
    if (!post) return <DefaultLayout><p>! No post found.</p></DefaultLayout>
            ...
            <Card>
                ...
                <CardBody>
                    ...
                    <Form onSubmit={handleCommentSubmit}>
                        <Input name="comment" value={comment} onChange={handleCommentChange} placeholder="Add a comment!" label="Comment" />
